...
<b>2026-06-17/b>
	...
	<b>2026-05-21</b>
	<ul>
		<li>Enable saving of forecast tables into exam.net as an image (extra button shows when NZGrapher is embedded
			into exam.net).</li>
	</ul>
	<b>2026-05-19</b>
	<ul>
	...
	<b>2026-05-16</b>
	<ul>
		<li>Changed the "p" on rerandomisation graphs to "proportion" to avoid confusion for students with p-values.
		</li>
	...
	<ul>
		...
		<li>Fixed issue where the simulation model wasn't displaying properly continuous distributions with decimals in
			the
			groups</li>
	</ul>
	<b>2026-03-31</b>
	...
	<ul>
		...
		<li>R-Value doesn't show by default anymore, but can still be shown when needed with a new checkbox - thanks to
			Ethan Hayward</li>
	...
	<ul>
		...
		<li>Added option to manually set the min and max on the x-axis for time series graphs (under more options) to
			allow
			adding of extra space to the end of the graph, which is useful for when making predictions infomally like
			required at Level 1</li>
		<li>Added new teaching tool - Bootstrapping Single Variable, which is great for introducing students to
			bootstrapping</li>
		<li>Added new teaching tool - CI Coverage, which is great for introducing students to confidence intervals</li>
		<li>Added new teaching tool - Simulation Model, which is great for helping students learn about randomness and
			how
			well models fit the data</li>
	</ul>
	<b>2025-08-07</b>
	<ul>
		<li>Increased the width of the — signs on the graphs to make them easier to see (in equations and bootstrap etc.
			axis titles)</li>
		<li>Changed LQ and UQ to uppercase to help prevent confusion for students with LQ and IQ</li>
		<li>Fixed time series forecasts to correctly show the first season of the cycle on the graph when hovering</li>
		<li>Improved algorithm used to create the shape outlines and violin graphs so they better match the shape of the
			data</li>
	</ul>
	<b>2025-05-01</b>
	<ul>
		<li>Fixed a bug that caused the wrong values to be shown on mupltiplicative models on time series seasonal
			effects.
		</li>
	...
	<ul>
		...
		<li>Big upgrade to school custom folders adding a bunch of new features... <a
				href='https://youtu.be/WGCiEJrp1LY'>video showing how to use</a>.</li>
	</ul>
	<b>2025-04-14</b>
	<ul>
		<li>Made it so the default is the points are lightly filled, can be turned off with a checkbox next to point
			transparency.</li>
		<li>Scatter Graphs: added the abiliy to colour by distance, as well as highlight the points furthest away from
			the
			centre (most impact on the trend) using the Mahalanobis distance. <a href='https://youtu.be/AYe81YiSNMo'
				target='_blank'>Video Explainer</a>.</li>
	</ul>
	<b>2025-03-27</b>
	<ul>
	...
	<b>2025-03-11</b>
	<ul>
		<li>Added MAD (Mean Absolute Deviation) to dot plots / box and whiskers. See more <a
				href='https://info.grapher.nz/graph-information/#dotplotandboxandwhisker:~:text=MAD,introduce%20standard%20deviation.'>here</a>.
		</li>
	</ul>
	<b>2025-02-17</b>
	<ul>
	...
	<b>2024-07-11</b>
	<ul>
		<li>Fixed issue where screens with limited vertical height couldn't use the third custom line as the dots were
			off
			the screen.</li>
	...
	<b>2024-05-17</b>
	<ul>
		<li>Fixed issue where colour by difference wasn't working for paired experiment data where some data was
			missing.
		</li>
		<li>Fixed issue where select and copy data table was still showing for datasets that shouldn't be downloaded.
		</li>
	</ul>
	<b>2024-03-07</b>
	<ul>
	...
	<b>2024-01-15</b>
	<ul>
		<li>Added option to have 3 custom lines on scatter graphs... great for showing railway tracks for the new Level
			1
			standards.</li>
	</ul>
	<b>2023-12-17</b>
	<ul>
		<li>New Quadrant Count and Quadrant Count Ratio option for scatter graphs. Read more about this <a
				href='https://en.wikipedia.org/wiki/Quadrant_count_ratio'>here</a>. This is at an appropriate level for
			the
			new Level 1 standards coming in next year.</li>
		<li>New option to show points and colour them by the season on the time series graph. This is a useful way for
			students doing the new level 1 standards to identify seasonal trends visually.</li>
	</ul>
	<b>2023-10-27</b>
	<ul>
		<li>New Probability Simulation option under "data" that allows you to run probability simulations - <a
				href='https://youtu.be/sNT6CCcjuqM'>video guide</a>.</li>
		<li>New Event Recorder option under "data" that allows you to record events as they happen (great for recording
			experiments) - <a href='https://youtu.be/r9npjB-KttM'>video guide</a>.</li>
		<li>New graph type: "Running Proportion" which is great for looking at long term probability and when the noise
			starts to reduce - <a href='https://youtu.be/JGpzK0YBOsg'>video guide</a>.</li>
	</ul>
	<b>2023-10-01</b>
	<ul>
		<li>'Fill Numbers' button on sample and sample variation screens... this button fills the sample boxes with the
			total number in each group to make removing groups easier.</li>
		<li>New Function: 'Sample and More' -> 'View Group(s)' allows you to easily view single or multiple groups in a
			particular category.</li>
	</ul>
	<b>2023-08-16</b>
	<ul>
	...
	<ul>
		...
		<li>Note: if colours of graphs are not working correctly on Safari, please update to the latest version, this is
			a
			bug with Safari, not NZGrapher.</li>
	</ul>
	<b>2022-11-28</b>
	<ul>
	...
	<ul>
		...
		<li>New options on Dot Plot with "Shape Outline", "Violin" and "Bee Swarm" options, as well as a "Hide Points"
			tickbox.</li>
		<li>Added ability to create stacked scatter graphs, where you fit the same linear trend line for each colour....
			play around, it's quite cool.</li>
	</ul>
	<b>2021-08-15</b>
	<ul>
	...
	<ul>
		...
		<li>Changed the font size of summary statistics on dot plots so they are more readable size. Option to adjust
			the
			size in the more options area.</li>
		<li>Added Survey to Front Page.</li>
	</ul>
	<b>2021-06-04</b>
	<ul>
		<li>Switch to hosting javascript libraries locally as lots of school networks were blocking schools from
			accessing
			them</li>
	</ul>
	<b>2021-06-02</b>
	...
	<ul>
		...
		<li>Added option to show mean dot onto scatter graphs which provides a pivot point for the trend line (useful
			for
			teaching trend lines).</li>
	...
	<b>2021-03-10</b>
	<ul>
		<li>Updated wording on re-randomisation teaching tool to make it more clear the difference between a
			re-randomisation distribution and a randomisation test.</li>
		<li>Bug fix for extra thick line at top of time series graphs when showing gridlines.</li>
		<li>Added privacy statement.</li>
		<li>Improvements to visibility of bootstrap confidence intervals when dataset has an extreme range but most data
			is
			within a small range.</li>
		<li>When launching the teaching tools the data box scrolls to the top so you can see the teaching tool if you
			are
			elsewhere in the dataset.</li>
	</ul>
	<b>2020-09-18</b>
	<ul>
	...
	<ul>
		...
		<li>Save the current session, including the variables, graph type and settings (Data -> Save Session)... this
			downloads a .nzgrapher file which can then be loaded back into NZGrapher later (using Data -> Open File or
			put
			into a school folder).</li>
		<li>NZGrapher now works offline... as long as you've visited the site before, it will work. There are a couple
			of
			limitiations while you are offline:
			<ul>
				<li>You can't load new datasets from online sources (opening files and importing from clipboard still
					works
					fine)</li>
	...
	<ul>
		...
		<li>New menu option - "Save Current State for Reset" which saves the current state of the data for when you
			press
			the reset button. Useful for if you are adding extra columns and then wanting to sample and reset.</li>
	</ul>
	<b>2020-01-20</b>
	<ul>
		<li>New Bootstrapping teaching tool.</li>
		<li>New <a href='https://youtu.be/RSeubxWEFAc' target='_blank'>video guide showing how to use the Bootstrapping
				teaching tool</a>.</li>
	...
	<ul>
		...
		<li>Re-Group option now under "Sampling and More" - great for grouping lots of variables down into 2 groups.
		</li>
	...
	<ul>
		<li>Updates to 'Bar Graph - Summary Data' graph type...
			<ul>
				...
				<li>when summaries is ticked numbers or percentages show in each group rather than at the top of all
					groups.
				</li>
				<li>create 'Area Graphs' by using the 'Relative Width' option.</li>
			</ul>
		</li>
		<li>Rebuild of 'Bar Graph' graph type - now has all the same features as the 'Bar Graph - Summary Data' graph
			type.
		</li>
	</ul>
	<b>2019-11-06</b>
	...
	<ul>
		...
		<li>New <a href='https://youtu.be/ttnhFlTUSag' target='_blank'>video guide showing how to use the
				Re-Randomisation
				teaching tool</a>.</li>
	...
	<b>2019-09-11</b>
	<ul>
		<li>New <a href='https://youtu.be/Mj8jwAmqCGY' target='_blank'>video guide showing how to use the Sampling
				Variability teaching tool</a>.</li>
	...
	<b>2019-07-03</b>
	<ul>
		<li>Change method of data collection for graph types used to better cope with higher volumes of traffic to
			NZGrapher.</li>
	</ul>
	<b>2019-06-30</b>
	<ul>
		<li>New option in dot plots to show as a strip graph, where instead of stacking dots, the vertical position of
			the
			dot is randomly allocated.</li>
	...
	<ul>
		...
		<li>Added hover boxes on scatter graphs, residuals, dot plots, and bootstrap confidence intervals so when you
			hover
			over a point it gives you details on the point and highlights it in the data table.</li>
		<li>Rebuild of residuals graph into javascript, including by default not showing weighted average line, this is
			now
			an option in the graph options area.</li>
	</ul>
	<b>2019-05-26</b>
	<ul>
	...
	<ul>
		...
		<li>Added "(STL)" after the Long Term Trend and Seasonal tickboxes on time series to clarify the method being
			used
			to draw these.</li>
	</ul>
	<b>2019-03-15</b>
	...
	<b>2019-01-13</b>
	<ul>
		<li>Added "Update Graph" button to "More Options" and changed it so the more options didn't overlap the graph.
		</li>
	</ul>
	<b>2018-12-18</b>
	<ul>
		<li>New feature - Sampling Variability... <a
				href='https://drive.google.com/file/d/1oox1SKylU7RdJU82ER5Imiw6dtju_qh2/view' target='_blank'>see a
				video
				here</a>.</li>
	</ul>
	<b>2018-11-17</b>
	...
	<ul>
		...
		<li>New Create Variable Option (from Condition) - useful for condensing categories or for creating categorical
			from
			numerical.</li>
	</ul>
	<b>2018-10-09</b>
	...
	<ul>
		...
		<li>New Option under 'Sample and More' -> 'Convert Time' to convert dates or times into seconds, minutes, hours
			or
			days (great for bivariate data).</li>
		<li>New Option under 'Sample and More' -> 'Encode Time' to encode dates / times into the correct format for the
			time
			series module. It averages / sums the numerical values and finds the most common non-numerical values if
			there
			is more than one time in each interval.</li>
	</ul>
	<b>2018-02-03</b>
	<ul>
	...
	<ul>
		<li>Bug Fixes.</li>
		<li>Fix for csv files created using terrible language settings that mean that comma separated values are
			separated
			by semicolons... these files should now work.</li>
	...
	<ul>
		<li>Bug Fixes.</li>
		<li>Added ability to set min and max for the axis on Dot Plots (and Box and Whisker) with the more options
			button.
		</li>
	</ul>
	<b>2016-02-17</b>
	...
	<ul>
		...
		<li>Hiding the left and bottom areas can now be done by clicking on the tripple dot menu in the top right
			corner.
		</li>
	</ul>
	<b>2015-09-22</b>
	...
	<b>2015-07-12</b>
	<ul>
		<li>Added ability to make the box and whisker graphs at the top of the graph rather than overlapping the dot
			plot.
		</li>
		<li>Bug Fixes.</li>
	</ul>
	...
	<ul>
		...
		<li>Added buttons to show and hide the left and bottom panels, particularly for when graphing on devices with
			smaller screens.</li>
	</ul>
	<b>2015-04-30</b>
	<ul>
	...
	<b>2015-03-06</b>
	<ul>
		<li>If a data point is not numeric in dotplots, scatter plots and residuals it now doesn't get graph the data
			points, but list their id in the top right of the graph.</li>
	...
	<b>2014-12-05</b>
	<ul>
		<li>Added in a slider to change the point sizes in dot plots, scatter plots, residuals, and all the bootstrap
			graphs.</li>
		<li>Made the section where the graph options are set scrollable.</li>
	</ul>
	<b>2014-12-05</b>
	<ul>
		<li>Datasets that start with SECURE (all in capitals) are not able to be downloaded using the download button.
		</li>
	</ul>
	<b>2014-12-05</b>
	<ul>
	...
	<b>2014-10-25</b>
	<ul>
		<li>Significantly improved the sampling module to allow it to use stratified sampling as well as simple random
			sampling.</li>
		<li>Added ability to reorder categorical variables.</li>
	</ul>
	<b>2014-10-24</b>
	<ul>
		<li>Disabled the ability to enter commas or line breaks into the data as this causes issues with the graphing.
		</li>
		<li>Added links to <a target='_blank' href="http://students.mathsnz.com/nzgrapher">MathsNZ Students</a> with
			video
			tutorials and dataset information.</li>
	</ul>
	<b>2014-10-06</b>
	<ul>
	...
	<b>2014-09-17</b>
	<ul>
		<li>Fixed an error with the bootstrap re-randomisation reversing the order of the bootstrap depending on the
			naming
			of groups.</li>
	...
	<ul>
		...
		<li>Fixed an error in the calculation of quartiles to use the same method we use in New Zealand, rather than the
			method used by Excel.</li>
	</ul>
	<b>2014-09-01</b>
	<ul>
		<li>Added more informative (pop-up) messages if file uploads fail. Maximum file size is 100kb and must be in CSV
			format.</li>
	</ul>
	<b>2014-08-29</b>
	<ul>
	...
	<b>2014-08-28</b>
	<ul>
		<li>Scatter plots no longer automatically add in the trend line, this must be added in by clicking the
			'Regression
			Line' button.</li>
		<li>Dot plots no longer automatically show the summary statistics or box and whiskers, this must be added in by
			clicking the 'Summaries' or 'Box Plots' buttons.</li>
		<li>Changed the way the labels for this button appear as well to make it more clear what each one does.</li>
		This has been done in an attempt to get students to write about what they see rather than what is calculated as
		a
		first step.</li>
	</ul>
	<b>2014-08-25</b>
	...
	<ul>
		...
		<li>Changed the images so you can right click to copy and paste into word / elsewhere or press and hold to save
			on
			iPad.</li>
