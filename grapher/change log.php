...
<ul>
	...
	<li>Fixed issue where the simulation model wasn't displaying properly continuous distributions with decimals in the
		groups</li>
</ul>
<b>2026-03-31</b>
<ul>
...
<ul>
	...
	<li>Added option to manually set the min and max on the x-axis for time series graphs (under more options) to allow
	...
	<li>Added new teaching tool - Simulation Model, which is great for helping students learn about randomness and how
...
<b>2025-05-01</b>
<ul>
	<li>Fixed a bug that caused the wrong values to be shown on mupltiplicative models on time series seasonal effects.
	</li>
...
<ul>
	<li>Made it so the default is the points are lightly filled, can be turned off with a checkbox next to point
		transparency.</li>
	<li>Scatter Graphs: added the abiliy to colour by distance, as well as highlight the points furthest away from the
...
<b>2024-07-11</b>
<ul>
	<li>Fixed issue where screens with limited vertical height couldn't use the third custom line as the dots were off
		the screen.</li>
...
<b>2024-05-17</b>
<ul>
	<li>Fixed issue where colour by difference wasn't working for paired experiment data where some data was missing.
	</li>
...
<b>2024-01-15</b>
<ul>
	<li>Added option to have 3 custom lines on scatter graphs... great for showing railway tracks for the new Level 1
		standards.</li>
</ul>
<b>2023-12-17</b>
<ul>
	<li>New Quadrant Count and Quadrant Count Ratio option for scatter graphs. Read more about this <a
			href='https://en.wikipedia.org/wiki/Quadrant_count_ratio'>here</a>. This is at an appropriate level for the
...
<ul>
	...
	<li>Note: if colours of graphs are not working correctly on Safari, please update to the latest version, this is a
...
<ul>
	...
	<li>Changed the font size of summary statistics on dot plots so they are more readable size. Option to adjust the
		size in the more options area.</li>
	<li>Added Survey to Front Page.</li>
</ul>
<b>2021-06-04</b>
<ul>
	<li>Switch to hosting javascript libraries locally as lots of school networks were blocking schools from accessing
		them</li>
</ul>
<b>2021-06-02</b>
<ul>
...
<ul>
	...
	<li>Added option to show mean dot onto scatter graphs which provides a pivot point for the trend line (useful for
...
<ul>
	...
	<li>Improvements to visibility of bootstrap confidence intervals when dataset has an extreme range but most data is
		within a small range.</li>
	<li>When launching the teaching tools the data box scrolls to the top so you can see the teaching tool if you are
...
<ul>
	...
	<li>Save the current session, including the variables, graph type and settings (Data -> Save Session)... this
		downloads a .nzgrapher file which can then be loaded back into NZGrapher later (using Data -> Open File or put
		into a school folder).</li>
	<li>NZGrapher now works offline... as long as you've visited the site before, it will work. There are a couple of
		limitiations while you are offline:
		<ul>
			<li>You can't load new datasets from online sources (opening files and importing from clipboard still works
				fine)</li>
...
<ul>
	...
	<li>New menu option - "Save Current State for Reset" which saves the current state of the data for when you press
...
<ul>
	<li>Updates to 'Bar Graph - Summary Data' graph type...
		<ul>
			...
			<li>when summaries is ticked numbers or percentages show in each group rather than at the top of all groups.
			</li>
			<li>create 'Area Graphs' by using the 'Relative Width' option.</li>
		</ul>
	</li>
	<li>Rebuild of 'Bar Graph' graph type - now has all the same features as the 'Bar Graph - Summary Data' graph type.
	</li>
</ul>
<b>2019-11-06</b>
<ul>
...
<ul>
	...
	<li>New <a href='https://youtu.be/ttnhFlTUSag' target='_blank'>video guide showing how to use the Re-Randomisation
			teaching tool</a>.</li>
...
<b>2019-06-30</b>
<ul>
	<li>New option in dot plots to show as a strip graph, where instead of stacking dots, the vertical position of the
...
<ul>
	...
	<li>Added hover boxes on scatter graphs, residuals, dot plots, and bootstrap confidence intervals so when you hover
		over a point it gives you details on the point and highlights it in the data table.</li>
	<li>Rebuild of residuals graph into javascript, including by default not showing weighted average line, this is now
...
<ul>
	...
	<li>Added "(STL)" after the Long Term Trend and Seasonal tickboxes on time series to clarify the method being used
		to draw these.</li>
</ul>
<b>2019-03-15</b>
<ul>
...
<ul>
	<li>New feature - Sampling Variability... <a
			href='https://drive.google.com/file/d/1oox1SKylU7RdJU82ER5Imiw6dtju_qh2/view' target='_blank'>see a video
			here</a>.</li>
</ul>
<b>2018-11-17</b>
<ul>
...
<ul>
	...
	<li>New Create Variable Option (from Condition) - useful for condensing categories or for creating categorical from
		numerical.</li>
</ul>
<b>2018-10-09</b>
<ul>
...
<ul>
	...
	<li>New Option under 'Sample and More' -> 'Convert Time' to convert dates or times into seconds, minutes, hours or
		days (great for bivariate data).</li>
	<li>New Option under 'Sample and More' -> 'Encode Time' to encode dates / times into the correct format for the time
		series module. It averages / sums the numerical values and finds the most common non-numerical values if there
...
<ul>
	<li>Bug Fixes.</li>
	<li>Fix for csv files created using terrible language settings that mean that comma separated values are separated
...
<ul>
	<li>Bug Fixes.</li>
	<li>Added ability to set min and max for the axis on Dot Plots (and Box and Whisker) with the more options button.
	</li>
</ul>
<b>2016-02-17</b>
<ul>
...
<ul>
	...
	<li>Hiding the left and bottom areas can now be done by clicking on the tripple dot menu in the top right corner.
	</li>
</ul>
<b>2015-09-22</b>
<ul>
...
<b>2015-07-12</b>
<ul>
	<li>Added ability to make the box and whisker graphs at the top of the graph rather than overlapping the dot plot.
	</li>
	<li>Bug Fixes.</li>
</ul>
<b>2015-07-11</b>
...
<ul>
	...
	<li>Added links to <a target='_blank' href="http://students.mathsnz.com/nzgrapher">MathsNZ Students</a> with video
...
<b>2014-09-17</b>
<ul>
	<li>Fixed an error with the bootstrap re-randomisation reversing the order of the bootstrap depending on the naming
		of groups.</li>
...
<b>2014-08-28</b>
<ul>
	<li>Scatter plots no longer automatically add in the trend line, this must be added in by clicking the 'Regression
		Line' button.</li>
	...
	This has been done in an attempt to get students to write about what they see rather than what is calculated as a
	first step.</li>
</ul>
<b>2014-08-25</b>
<ul>
...
<ul>
	...
	<li>Changed the images so you can right click to copy and paste into word / elsewhere or press and hold to save on
		iPad.</li>
