...
foreach ($categories as $values){
	...
	$med=Quartile($points,0.5);
	array_push($meds,$med);
	$i++;
}
$differ=max($meds)-min($meds);
...
// output png and save
imagepng($im,'imagetemp/BSRerandomMed-'.$randomString.'.png');

echo "<img style='position:absolute;top:0px;left:0px;' src='imagetemp/BSRerandomMed-".$randomString.".png' />";
?>
